...
//
//   The only intentional difference is the lookback window: this script
//   queries from 2022-01-01 instead of the scheduled job's 2024-01-01 so
//   you can also see whether legitimate pre-2024 data exists.
// ════════════════════════════════════════════════════════════════════════════
...
// sys_created_on >= 2022-...  → wider than the scheduled job's window so
//                                we also see legitimate older cases
...
gs.info('═══════════════════════════════════════════════════════');
gs.info('');
gs.info('Query: state IN (3,6) AND sys_created_on >= 2024-01-01');
gs.info('       + account NOT NULL + u_project NOT NULL + business_duration NOT NULL');
gs.info('');
gs.info('SUMMARY:');
