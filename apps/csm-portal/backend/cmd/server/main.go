...
func main() {
	...
	route("GET /updates/product-update-levels", handler.PermView, updatesHandler.GetProductUpdateLevels)
	route("POST /updates/levels/search", handler.PermView, updatesHandler.SearchUpdatesBetweenUpdateLevels)
	...
	route("POST /time-cards/search", handler.PermView, timeCardHandler.SearchTimeCards)
	route("POST /time-cards", handler.PermWrite, timeCardHandler.CreateTimeCard)
	route("PATCH /time-cards/{id}", handler.PermWrite, timeCardHandler.UpdateTimeCard)
	route("DELETE /time-cards/{id}", handler.PermWrite, timeCardHandler.DeleteTimeCard)
