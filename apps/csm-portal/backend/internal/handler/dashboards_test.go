...
const testDashboardsConfigJSON = `[
  ...
  {"id":"sample-team-dashboard","displayName":"Sample Team Dashboard","targetTeam":"sample-team","isTeamBased":true,"widgets":[
    ...
    {"id":"cases-by-severity","displayName":"Cases by Severity","description":"Share of active cases at each severity level.","resourceType":"case","shape":"pie","gridWidth":4,"query":{"filters":[{"field":"state","op":"in","values":["open","work_in_progress"]}]},"inlineDrilldown":true,"slices":[
