...
type CaseRepository interface {
	...
	// one of "case"/service_request/engagement/security_report_analysis,
	// branching on req.Type -- see createServiceRequestFromServiceNowQuery/
	// createEngagementFromServiceNowQuery/createSecurityReportAnalysisFromServiceNowQuery's
	// own doc comments for why the three non-case types need a genuinely
	...
	// of those four (validated by the caller). Unlike CreateCase, identity is
